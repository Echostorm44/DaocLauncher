...
using static DaocLauncher.Helpers.NativeMethods;
using Luid = DaocLauncher.Helpers.NativeMethods.LUID;
...
public static class Privilege
{
    ...
    private static LUID_AND_ATTRIBUTES[] AdjustTokenPrivileges2(SafeTokenHandle token, LUID_AND_ATTRIBUTES[] attrs)
    {
        ...
        try
        {
            ...
            {
                Marshal.FreeHGlobal(pPrevious);
            }
        }
        finally
        {
            Marshal.FreeHGlobal(pDesired);
        }
    }
